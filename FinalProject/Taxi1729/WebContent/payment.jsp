...
<body style="background-image:url(./images/pic1.png)">
                ...
                <img src="images/logonew.png" alt="..." width="150px" />
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <div class="pricing">
                            <div class="title">
                              <h2>Checkout</h2>
                                <% String imagePath = (String) request.getAttribute("carPath"); %>
                              ...
                              <div class="">
                                <div class="pricing_features">
                                  ...
                                  <h2><%= request.getAttribute("carName") %>&emsp;<small><%= request.getAttribute("carType") %></small></h2>
                                    ...
                                    <li><i class="fa fa-check text-success"></i> <strong>Car Color: </strong><%= request.getAttribute("carColor") %></li>
                                    <li><i class="fa fa-check text-success"></i> Trip Days <strong><%= days %></strong></li>
                                    <li><i class="fa fa-check text-success"></i> <strong>Cost per day</strong><%= request.getAttribute("carCost") %></li>
                                    <li><i class="fa fa-check text-success"></i>Insurance per day <strong> <%= request.getAttribute("insuranceCost") %></strong></li>
                                    <li><i class="fa fa-check text-success"></i> <strong>Final Cost</strong> <%= request.getAttribute("finalCost") %></li>
    ...
    <div class="modal__container" >
      ...
      <div class="modal__content">
        ...
        <form method="POST" action="rentPaymentSuccess">
          <ul class="form-list">
