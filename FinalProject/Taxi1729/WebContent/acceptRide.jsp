...
<title>Taxi1729 | Accept Ride</title>
		...
		<div class="main_container">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <% ResultSet rs = (ResultSet) request.getAttribute("riderequests"); %>
              	<% while(rs.next()) { %>
                <div class="x_panel">
                  <div class="x_title">
                  ...
                  <div class="x_content">
					<form class="form-horizontal form-label-left" method="POST" action="saveRide" >
                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12" style="border:0px solid #e5e5e5;">
                      ...
                      <div class="item form-group">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" name="carType" for="name"><h2><%=rs.getString("car_type") %></h2> 
                           ...
                           <input  type="hidden" name="hidden_Car" value=<%=rs.getString("car_brand") %>>
                         	...
                         	<input type="hidden" name="hidden_driver" value=<%=rs.getString("car_driver") %>>
                        </div>
                      </div>
                      ...
                      <div class="">
                        <div class="product_price">
                                           ...
                                           <div class="item form-group">
                        <label class="control-label col-md-6 col-sm-6 col-xs-12 price" for="number">Ride Cost:
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
